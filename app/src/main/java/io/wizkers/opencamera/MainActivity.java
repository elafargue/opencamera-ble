...
import io.wizkers.opencamera.CameraController.CameraControllerManager2;
import io.wizkers.opencamera.Preview.Preview;
import io.wizkers.opencamera.Preview.VideoProfile;
import io.wizkers.opencamera.Remotecontrol.BluetoothLeService;
import io.wizkers.opencamera.UI.FolderChooserDialog;
import io.wizkers.opencamera.UI.MainUI;
import io.wizkers.opencamera.UI.ManualSeekbars;
...
public class MainActivity extends Activity {
	...
	static private final String ACTION_SHORTCUT_CAMERA = "net.io.wizkers.opencamera.SHORTCUT_CAMERA";
	static private final String ACTION_SHORTCUT_SELFIE = "net.io.wizkers.opencamera.SHORTCUT_SELFIE";
	static private final String ACTION_SHORTCUT_VIDEO = "net.io.wizkers.opencamera.SHORTCUT_VIDEO";
	static private final String ACTION_SHORTCUT_GALLERY = "net.io.wizkers.opencamera.SHORTCUT_GALLERY";
	static private final String ACTION_SHORTCUT_SETTINGS = "net.io.wizkers.opencamera.SHORTCUT_SETTINGS";
	...
	void launchOnlineHelp(String append) {
		...
		Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://opencamera.io.wizkers.io/"+ append));
		startActivity(browserIntent);
	}
