package io.wizkers.opencamera.test;
...
import io.wizkers.opencamera.CameraController.CameraController2;
import io.wizkers.opencamera.HDRProcessor;
import io.wizkers.opencamera.HDRProcessorException;
import io.wizkers.opencamera.ImageSaver;
import io.wizkers.opencamera.MainActivity;
import io.wizkers.opencamera.MyApplicationInterface;
import io.wizkers.opencamera.PreferenceKeys;
import io.wizkers.opencamera.Preview.VideoProfile;
import io.wizkers.opencamera.SaveLocationHistory;
import io.wizkers.opencamera.CameraController.CameraController;
import io.wizkers.opencamera.Preview.Preview;
import io.wizkers.opencamera.UI.FolderChooserDialog;
import io.wizkers.opencamera.UI.PopupView;
...
public class MainActivityTest extends ActivityInstrumentationTestCase2<MainActivity> {
    ...
    public MainActivityTest() {
        super("io.wizkers.opencamera", MainActivity.class);
    }
    ...
    private void switchToFlashValue(String required_flash_value) {
        if( mPreview.supportsFlash() ) {
            ...
            if( !flash_value.equals(required_flash_value) ) {
                ...
                View popupButton = mActivity.findViewById(io.wizkers.opencamera.R.id.popup);
    ...
    private void switchToISO(int required_iso) {
        ...
        if( iso != required_iso ) {
            ...
            View exposureButton = mActivity.findViewById(io.wizkers.opencamera.R.id.exposure);
            View exposureContainer = mActivity.findViewById(io.wizkers.opencamera.R.id.exposure_container);
    ...
    private void setToDefault() {
        ...
        if( mPreview.isVideo() ) {
            ...
            View switchVideoButton = mActivity.findViewById(io.wizkers.opencamera.R.id.switch_video);
        ...
        if( mPreview.getCameraControllerManager().getNumberOfCameras() > 1 ) {
            ...
            while( cameraId != 0 ) {
                View switchCameraButton = mActivity.findViewById(io.wizkers.opencamera.R.id.switch_camera);
    ...
    private void subTestSaveVideoMode() {
        ...
        View takePhotoButton = mActivity.findViewById(io.wizkers.opencamera.R.id.take_photo);
        View switchVideoButton = mActivity.findViewById(io.wizkers.opencamera.R.id.switch_video);

        assertTrue(!mPreview.isVideo());
        assertTrue( takePhotoButton.getContentDescription().equals( mActivity.getResources().getString(io.wizkers.opencamera.R.string.take_photo) ) );
        assertTrue( switchVideoButton.getContentDescription().equals( mActivity.getResources().getString(io.wizkers.opencamera.R.string.switch_to_video) ) );

        clickView(switchVideoButton);
        waitUntilCameraOpened();
        assertTrue(mPreview.isVideo());
        assertTrue( takePhotoButton.getContentDescription().equals( mActivity.getResources().getString(io.wizkers.opencamera.R.string.start_video) ) );
        assertTrue( switchVideoButton.getContentDescription().equals( mActivity.getResources().getString(io.wizkers.opencamera.R.string.switch_to_photo) ) );
    ...
    private void subTestExposureLockNotSaved() {
        ...
        View exposureLockButton = mActivity.findViewById(io.wizkers.opencamera.R.id.exposure_lock);
        assertTrue( exposureLockButton.getContentDescription().equals( mActivity.getResources().getString(io.wizkers.opencamera.R.string.exposure_lock) ) );
        clickView(exposureLockButton);
        assertTrue(mPreview.getCameraController().getAutoExposureLock());
        assertTrue( exposureLockButton.getContentDescription().equals( mActivity.getResources().getString(io.wizkers.opencamera.R.string.exposure_unlock) ) );
        ...
        restart();
        assertTrue(!mPreview.getCameraController().getAutoExposureLock());
        exposureLockButton = mActivity.findViewById(io.wizkers.opencamera.R.id.exposure_lock);
        assertTrue( exposureLockButton.getContentDescription().equals( mActivity.getResources().getString(io.wizkers.opencamera.R.string.exposure_lock) ) );
    }
    ...
    private void subTestWhiteBalanceLockNotSaved() {
        ...
        View whiteBalanceLockButton = mActivity.findViewById(io.wizkers.opencamera.R.id.white_balance_lock);
        ...
        assertTrue( whiteBalanceLockButton.getContentDescription().equals( mActivity.getResources().getString(io.wizkers.opencamera.R.string.white_balance_lock) ) );
        clickView(whiteBalanceLockButton);
        assertTrue(mPreview.getCameraController().getAutoWhiteBalanceLock());
        assertTrue( whiteBalanceLockButton.getContentDescription().equals( mActivity.getResources().getString(io.wizkers.opencamera.R.string.white_balance_unlock) ) );
        ...
        restart();
        assertTrue(!mPreview.getCameraController().getAutoWhiteBalanceLock());
        whiteBalanceLockButton = mActivity.findViewById(io.wizkers.opencamera.R.id.white_balance_lock);
        assertTrue( whiteBalanceLockButton.getContentDescription().equals( mActivity.getResources().getString(io.wizkers.opencamera.R.string.white_balance_lock) ) );
    }
    ...
    public void testFlashVideoMode() {
        ...
        restart();
        switchVideoButton = mActivity.findViewById(io.wizkers.opencamera.R.id.switch_video);
        assertTrue(mPreview.isVideo());
        assertTrue(mPreview.getCurrentFlashValue().equals("flash_off"));
    ...
    public void testFlashStartup() throws InterruptedException {
        ...
        //View flashButton = mActivity.findViewById(io.wizkers.opencamera.R.id.flash);
        //clickView(flashButton);
        switchToFlashValue("flash_torch");
    ...
    public void testAutoFocus() throws InterruptedException {
        ...
        for(String supported_focus_value : supported_focus_values) {
            ...
            //View focusModeButton = mActivity.findViewById(io.wizkers.opencamera.R.id.focus_mode);
    ...
    public void testFaceDetection() throws InterruptedException {
        ...
        View faceDetectionButton = mActivity.findViewById(io.wizkers.opencamera.R.id.face_detection);
        ...
        */
        ...
        assertTrue( faceDetectionButton.getContentDescription().equals( mActivity.getResources().getString(io.wizkers.opencamera.R.string.face_detection_disable) ) );
        ...
        restart();
        faceDetectionButton = mActivity.findViewById(io.wizkers.opencamera.R.id.face_detection);
        ...
        assertTrue( faceDetectionButton.getContentDescription().equals( mActivity.getResources().getString(io.wizkers.opencamera.R.string.face_detection_enable) ) );
    ...
    private void subTestPopupButtonContentDescription(int title_id, String test_key, boolean next, boolean expected) {
        ...
        if( button != null ) {
            ...
            String next_string = mActivity.getResources().getString(next ? io.wizkers.opencamera.R.string.next : io.wizkers.opencamera.R.string.previous);
    ...
    public void testSwitchVideo() {
        ...
        subTestPopupButtonContentDescription(io.wizkers.opencamera.R.string.preference_resolution, "PHOTO_RESOLUTIONS", false, true);
        subTestPopupButtonContentDescription(io.wizkers.opencamera.R.string.preference_resolution, "PHOTO_RESOLUTIONS", true, false);
        subTestPopupButtonContentDescription(io.wizkers.opencamera.R.string.preference_timer, "TIMER", false, false);
        subTestPopupButtonContentDescription(io.wizkers.opencamera.R.string.preference_timer, "TIMER", true, true);
        subTestPopupButtonContentDescription(io.wizkers.opencamera.R.string.preference_burst_mode, "REPEAT_MODE", false, false);
        subTestPopupButtonContentDescription(io.wizkers.opencamera.R.string.preference_burst_mode, "REPEAT_MODE", true, true);
        subTestPopupButtonContentDescription(io.wizkers.opencamera.R.string.grid, "GRID", false, true);
        subTestPopupButtonContentDescription(io.wizkers.opencamera.R.string.grid, "GRID", true, true);
        ...
        Log.d(TAG, "popup is now open");
        subTestPopupButtonContentDescription(io.wizkers.opencamera.R.string.video_quality, "VIDEO_RESOLUTIONS", false, true);
        subTestPopupButtonContentDescription(io.wizkers.opencamera.R.string.video_quality, "VIDEO_RESOLUTIONS", true, false);
        if( mActivity.getApplicationInterface().getSupportedVideoCaptureRates().size() > 1 ) {
            subTestPopupButtonContentDescription(io.wizkers.opencamera.R.string.preference_video_capture_rate, "VIDEOCAPTURERATE", false, false);
            subTestPopupButtonContentDescription(io.wizkers.opencamera.R.string.preference_video_capture_rate, "VIDEOCAPTURERATE", true, true);
        }
        subTestPopupButtonContentDescription(io.wizkers.opencamera.R.string.preference_timer, "TIMER", false, false);
        subTestPopupButtonContentDescription(io.wizkers.opencamera.R.string.preference_timer, "TIMER", true, true);
        subTestPopupButtonContentDescription(io.wizkers.opencamera.R.string.preference_burst_mode, "REPEAT_MODE", false, false);
    ...
    public void testTakePhotoExposureCompensation() throws InterruptedException {
        ...
        View exposureButton = mActivity.findViewById(io.wizkers.opencamera.R.id.exposure);
        View exposureContainer = mActivity.findViewById(io.wizkers.opencamera.R.id.exposure_container);
        SeekBar seekBar = mActivity.findViewById(io.wizkers.opencamera.R.id.exposure_seekbar);
    ...
    public void testTakePhotoManualISOExposure() throws InterruptedException {
        ...
        View exposureButton = mActivity.findViewById(io.wizkers.opencamera.R.id.exposure);
        View exposureContainer = mActivity.findViewById(io.wizkers.opencamera.R.id.manual_exposure_container);
        SeekBar isoSeekBar = mActivity.findViewById(io.wizkers.opencamera.R.id.iso_seekbar);
        SeekBar exposureTimeSeekBar = mActivity.findViewById(io.wizkers.opencamera.R.id.exposure_time_seekbar);
        assertTrue(exposureButton.getVisibility() == View.VISIBLE);
        assertTrue(exposureContainer.getVisibility() == View.GONE);
    ...
    public void testTakePhotoManualWB() throws InterruptedException {
        ...
        SeekBar white_balance_seek_bar = mActivity.findViewById(io.wizkers.opencamera.R.id.white_balance_seekbar);
        ...
        ScrollView popupContainer = (ScrollView)mActivity.findViewById(io.wizkers.opencamera.R.id.popup_container);
        ...
        */
        ...
        View exposureContainer = mActivity.findViewById(io.wizkers.opencamera.R.id.exposure_container);
        SeekBar seekBar = mActivity.findViewById(io.wizkers.opencamera.R.id.exposure_seekbar);
        View manualWBContainer = mActivity.findViewById(io.wizkers.opencamera.R.id.manual_white_balance_container);
        SeekBar seekBarWB = mActivity.findViewById(io.wizkers.opencamera.R.id.white_balance_seekbar);
    ...
    public void testAudioControlIcon() {
        ...
        View audioControlButton = mActivity.findViewById(io.wizkers.opencamera.R.id.audio_control);
        ...
        audioControlButton = mActivity.findViewById(io.wizkers.opencamera.R.id.audio_control);
    ...
    private void waitForTakePhoto() {
        ...
        View switchVideoButton = mActivity.findViewById(io.wizkers.opencamera.R.id.switch_video);
        //View flashButton = mActivity.findViewById(io.wizkers.opencamera.R.id.flash);
        //View focusButton = mActivity.findViewById(io.wizkers.opencamera.R.id.focus_mode);
        View exposureButton = mActivity.findViewById(io.wizkers.opencamera.R.id.exposure);
        View exposureLockButton = mActivity.findViewById(io.wizkers.opencamera.R.id.exposure_lock);
        View audioControlButton = mActivity.findViewById(io.wizkers.opencamera.R.id.audio_control);
        View popupButton = mActivity.findViewById(io.wizkers.opencamera.R.id.popup);
        View trashButton = mActivity.findViewById(io.wizkers.opencamera.R.id.trash);
        View shareButton = mActivity.findViewById(io.wizkers.opencamera.R.id.share);
    ...
    public void testTakePhotoFrontCamera() throws InterruptedException {
        ...
        assertTrue(cameraId != new_cameraId);
        assertTrue( contentDescription.equals( mActivity.getResources().getString(new_is_front_facing ? io.wizkers.opencamera.R.string.switch_to_front_camera : io.wizkers.opencamera.R.string.switch_to_back_camera) ) );
        assertTrue( new_contentDescription.equals( mActivity.getResources().getString(is_front_facing ? io.wizkers.opencamera.R.string.switch_to_front_camera : io.wizkers.opencamera.R.string.switch_to_back_camera) ) );
        subTestTakePhoto(false, false, true, true, false, false, false, false);
        ...
        assertTrue( restart_contentDescription.equals( mActivity.getResources().getString(is_front_facing ? io.wizkers.opencamera.R.string.switch_to_front_camera : io.wizkers.opencamera.R.string.switch_to_back_camera) ) );
    ...
    public void testTakePhotoManualFocus() throws InterruptedException {
        ...
        SeekBar seekBar = mActivity.findViewById(io.wizkers.opencamera.R.id.focus_seekbar);
    ...
    public void testImmersiveMode() throws InterruptedException {
        ...
        View trashButton = mActivity.findViewById(io.wizkers.opencamera.R.id.trash);
        View shareButton = mActivity.findViewById(io.wizkers.opencamera.R.id.share);
        View zoomSeekBar = mActivity.findViewById(io.wizkers.opencamera.R.id.zoom_seekbar);
        View takePhotoButton = mActivity.findViewById(io.wizkers.opencamera.R.id.take_photo);
        View pauseVideoButton = mActivity.findViewById(io.wizkers.opencamera.R.id.pause_video);
        View takePhotoVideoButton = mActivity.findViewById(io.wizkers.opencamera.R.id.take_photo_when_video_recording);
        assertTrue(switchCameraButton.getVisibility() == View.VISIBLE);
        assertTrue(switchVideoButton.getVisibility() == View.VISIBLE);
        int exposureVisibility = exposureButton.getVisibility();
        int exposureLockVisibility = exposureLockButton.getVisibility();
    ...
    private int subTestTakeVideo(boolean test_exposure_lock, boolean test_focus_area, boolean allow_failure, boolean immersive_mode, VideoTestCallback test_cb, long time_ms, boolean max_filesize, boolean subtitles) throws InterruptedException {
        ...
        View switchVideoButton = mActivity.findViewById(io.wizkers.opencamera.R.id.switch_video);
        if( mPreview.isVideo() ) {
            assertTrue( (Integer)takePhotoButton.getTag() == io.wizkers.opencamera.R.drawable.take_video_selector );
            assertTrue( (Integer)switchVideoButton.getTag() == io.wizkers.opencamera.R.drawable.take_photo );
            assertTrue( takePhotoButton.getContentDescription().equals( mActivity.getResources().getString(io.wizkers.opencamera.R.string.start_video) ) );
            assertTrue( pauseVideoButton.getContentDescription().equals( mActivity.getResources().getString(io.wizkers.opencamera.R.string.pause_video) ) );
            assertTrue( switchVideoButton.getContentDescription().equals( mActivity.getResources().getString(io.wizkers.opencamera.R.string.switch_to_photo) ) );
        }
        else {
            assertTrue( (Integer)takePhotoButton.getTag() == io.wizkers.opencamera.R.drawable.take_photo_selector );
            assertTrue( (Integer)switchVideoButton.getTag() == io.wizkers.opencamera.R.drawable.take_video );
            assertTrue( takePhotoButton.getContentDescription().equals( mActivity.getResources().getString(io.wizkers.opencamera.R.string.take_photo) ) );
            assertTrue( pauseVideoButton.getContentDescription().equals( mActivity.getResources().getString(io.wizkers.opencamera.R.string.pause_video) ) );
            assertTrue( switchVideoButton.getContentDescription().equals( mActivity.getResources().getString(io.wizkers.opencamera.R.string.switch_to_video) ) );
        }
        ...
        if( mPreview.isVideoRecording() ) {
            assertTrue( (Integer)takePhotoButton.getTag() == io.wizkers.opencamera.R.drawable.take_video_recording );
            assertTrue( (Integer)switchVideoButton.getTag() == io.wizkers.opencamera.R.drawable.take_photo );
            assertTrue( takePhotoButton.getContentDescription().equals( mActivity.getResources().getString(io.wizkers.opencamera.R.string.stop_video) ) );
            assertTrue( pauseVideoButton.getContentDescription().equals( mActivity.getResources().getString(io.wizkers.opencamera.R.string.pause_video) ) );
        ...
        assertTrue( (Integer)takePhotoButton.getTag() == io.wizkers.opencamera.R.drawable.take_video_selector );
        assertTrue( (Integer)switchVideoButton.getTag() == io.wizkers.opencamera.R.drawable.take_photo );
        assertEquals( takePhotoButton.getContentDescription(), mActivity.getResources().getString(io.wizkers.opencamera.R.string.start_video) );
        assertTrue( pauseVideoButton.getContentDescription().equals( mActivity.getResources().getString(io.wizkers.opencamera.R.string.pause_video) ) );
    ...
    public void testTakeVideoPause() throws InterruptedException {
        ...
        final View pauseVideoButton = mActivity.findViewById(io.wizkers.opencamera.R.id.pause_video);
        assertTrue( pauseVideoButton.getVisibility() == View.GONE );
        ...
        subTestTakeVideo(false, false, false, false, new VideoTestCallback() {
            ...
            public int doTest() {
                ...
                assertTrue( pauseVideoButton.getContentDescription().equals( mActivity.getResources().getString(io.wizkers.opencamera.R.string.resume_video) ) );
                assertTrue( pauseVideoButton.getVisibility() == View.VISIBLE );
                assertTrue( mPreview.isVideoRecording() );
                assertTrue( mPreview.isVideoRecordingPaused() );
    ...
    private void subTestTakeVideoSnapshot() throws InterruptedException {
        ...
        final View takePhotoVideoButton = mActivity.findViewById(io.wizkers.opencamera.R.id.take_photo_when_video_recording);
        assertTrue( takePhotoVideoButton.getVisibility() == View.GONE );
    ...
    public void testTakeVideoSettings() throws InterruptedException {
        ...
        // now go to settings
        View settingsButton = mActivity.findViewById(io.wizkers.opencamera.R.id.settings);
    ...
    private void subTestTimer(int type) {
        ...
        try {
            ...
            takePhotoButton = mActivity.findViewById(io.wizkers.opencamera.R.id.take_photo);
    ...
    public void testPopupLeftLayout() {
        ...
        View popup_view = mActivity.findViewById(io.wizkers.opencamera.R.id.popup_container);
    ...
    public void testPopupLayout() throws InterruptedException {
        ...
        for(int i=0;i<50;i++) {
            View popup_container = mActivity.findViewById(io.wizkers.opencamera.R.id.popup_container);
            View popupButton = mActivity.findViewById(io.wizkers.opencamera.R.id.popup);
            final float scale = mActivity.getResources().getDisplayMetrics().density;
    ...
    public void testZoom() {
        ...
        final ZoomControls zoomControls = mActivity.findViewById(io.wizkers.opencamera.R.id.zoom);
        assertTrue(zoomControls.getVisibility() == View.GONE);

        final SeekBar zoomSeekBar = mActivity.findViewById(io.wizkers.opencamera.R.id.zoom_seekbar);
        assertTrue(zoomSeekBar.getVisibility() == View.VISIBLE);
    ...
    public void testGallery() {
        ...
        View galleryButton = mActivity.findViewById(io.wizkers.opencamera.R.id.gallery);
    ...
    private void setUpFocusBracketing() throws InterruptedException {
        SeekBar focusSeekBar = mActivity.findViewById(io.wizkers.opencamera.R.id.focus_seekbar);
        SeekBar focusTargetSeekBar = mActivity.findViewById(io.wizkers.opencamera.R.id.focus_bracketing_target_seekbar);
    ...
    private void subTestTakePhotoContinuousBurst(boolean is_slow) throws InterruptedException {
        ...
        final View takePhotoButton = mActivity.findViewById(io.wizkers.opencamera.R.id.take_photo);
        Log.d(TAG, "about to click take photo");
        mActivity.runOnUiThread(new Runnable() {
            public void run() {
