...
public class MainActivityTest extends ActivityInstrumentationTestCase2<MainActivity> {
	...
	public MainActivityTest() {
		super("net.io.wizkers.opencamera", MainActivity.class);
	}
	...
	private void switchToISO(int required_iso) {
		...
		if( iso != required_iso ) {
			/*assertFalse( mActivity.popupIsOpen() );
			View popupButton = mActivity.findViewById(net.io.wizkers.opencamera.R.id.popup);
			clickView(popupButton);
			while( !mActivity.popupIsOpen() ) {
			}
	...
	/*public void testSaveFlashTorchSwitchCamera() {
		...
		int cameraId = mPreview.getCameraId();
	    View switchCameraButton = mActivity.findViewById(net.io.wizkers.opencamera.R.id.switch_camera);
	    clickView(switchCameraButton);
		waitUntilCameraOpened();
	...
	public void testFlashStartup() throws InterruptedException {
	    ...
	    //View flashButton = mActivity.findViewById(net.io.wizkers.opencamera.R.id.flash);
	    //clickView(flashButton);
		switchToFlashValue("flash_torch");
	...
	public void testAutoFocus() throws InterruptedException {
		...
		for(String supported_focus_value : supported_focus_values) {
		    ...
		    //View focusModeButton = mActivity.findViewById(net.io.wizkers.opencamera.R.id.focus_mode);
	...
	public void testTakePhotoManualWB() throws InterruptedException {
		...
		ScrollView popupContainer = (ScrollView)mActivity.findViewById(net.io.wizkers.opencamera.R.id.popup_container);
	...
	private void waitForTakePhoto() {
		...
		View switchVideoButton = mActivity.findViewById(io.wizkers.opencamera.R.id.switch_video);
		//View flashButton = mActivity.findViewById(net.io.wizkers.opencamera.R.id.flash);
		//View focusButton = mActivity.findViewById(net.io.wizkers.opencamera.R.id.focus_mode);
		View exposureButton = mActivity.findViewById(io.wizkers.opencamera.R.id.exposure);
		View exposureLockButton = mActivity.findViewById(io.wizkers.opencamera.R.id.exposure_lock);
		View audioControlButton = mActivity.findViewById(io.wizkers.opencamera.R.id.audio_control);
		View popupButton = mActivity.findViewById(io.wizkers.opencamera.R.id.popup);
	...
	public void testPopupLayout() throws InterruptedException {
	    ...
	    for(int i=0;i<50;i++) {
			...
			/*View settingsButton = mActivity.findViewById(net.io.wizkers.opencamera.R.id.settings);
			Log.d(TAG, "about to click settings");
			clickView(settingsButton);
			Log.d(TAG, "done clicking settings");
			this.getInstrumentation().waitForIdleSync();*/
